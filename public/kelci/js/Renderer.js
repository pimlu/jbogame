...
function Renderer(o) {
  ...
  var tex = THREE.ImageUtils.loadTexture( 'textures/crate.gif' );
...
Renderer.prototype.makeblocker=function() {
  ...
  applycss($(this.blocker),'color:#fff;background-color:rgba(0,0,0,0.5);'+
    'width:100%;height:100%;position:absolute;'+
    'font-family:sans-serif;font-size:2em;');
  this.instr=document.createElement('div');
  applycss($(this.instr),'display:-moz-box;width:100%;height:100%;'+
